...
namespace EmeraldBot.Model.Migrations
{
    ...
    [Migration("20190625212753_Curriculum")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmeraldBot.Model.Characters.CharacterGear", b =>
                {
            ...
            modelBuilder.Entity("EmeraldBot.Model.Game.GearQuality", b =>
                {
                    ...
                    b.ToTable("GearQualities");
                });

            modelBuilder.Entity("EmeraldBot.Model.Game.GearRarity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("GearRarity");
                });

            modelBuilder.Entity("EmeraldBot.Model.Game.MoneySum", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EmeraldBot.Model.Scenes.Action", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EmeraldBot.Model.Scenes.ActionScenes", b =>
                {
                    b.Property<int>("ActionID");
            ...
            modelBuilder.Entity("EmeraldBot.Model.Scenes.ActionType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EmeraldBot.Model.Scenes.ActionTypeAction", b =>
                {
            ...
            modelBuilder.Entity("EmeraldBot.Model.Scenes.Conflict", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EmeraldBot.Model.Scenes.ConflictAction", b =>
                {
            ...
            modelBuilder.Entity("EmeraldBot.Model.Scenes.ConflictParticipant", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EmeraldBot.Model.Scenes.ConflictType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EmeraldBot.Model.Scenes.SceneType", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EmeraldBot.Model.Game.OpportunityTrigger", b =>
                {
                    b.HasOne("EmeraldBot.Model.Scenes.Action", "Action")
                        .WithMany()
                    ...
                    b.HasOne("EmeraldBot.Model.Scenes.SceneType", "SceneType")
                        .WithMany()
            ...
            modelBuilder.Entity("EmeraldBot.Model.Scenes.ActionTypeAction", b =>
                {
                    ...
                    b.HasOne("EmeraldBot.Model.Scenes.ActionType", "ActionType")
                        .WithMany("Actions")
            ...
            modelBuilder.Entity("EmeraldBot.Model.Scenes.Conflict", b =>
                {
                    b.HasOne("EmeraldBot.Model.Scenes.ConflictType", "ConflictType")
                        .WithMany()
            ...
            modelBuilder.Entity("EmeraldBot.Model.Scenes.ConflictAction", b =>
                {
                    ...
                    b.HasOne("EmeraldBot.Model.Scenes.ConflictType", "Conflict")
                        .WithMany("Actions")
            ...
            modelBuilder.Entity("EmeraldBot.Model.Characters.Character", b =>
                {
                    b.HasOne("EmeraldBot.Model.Game.MoneySum", "Money")
                        .WithMany()
            ...
            modelBuilder.Entity("EmeraldBot.Model.Game.Gear", b =>
                {
                    b.HasOne("EmeraldBot.Model.Game.MoneySum", "Cost")
                        .WithMany()
                        .HasForeignKey("CostID")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("EmeraldBot.Model.Game.GearRarity", "Rarity")
                        .WithMany()
